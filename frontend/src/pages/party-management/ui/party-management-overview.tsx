...
function QuickActionCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="group flex w-full items-center justify-between rounded-3xl border border-slate-200 bg-white p-5 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md"
    >
...
export function PartyManagementOverview() {
  ...
  return (
    <div className="space-y-8">
      <section className="overflow-hidden rounded-[32px] bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.16),_transparent_35%),linear-gradient(135deg,_#ffffff_0%,_#f8fbff_48%,_#eef6ff_100%)] p-8 shadow-sm ring-1 ring-slate-200 md:p-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 md:text-lg">
            기존 메인 화면이 맡고 있던 파티 리스트와 스케줄링 중심 흐름을 파티관리 내부로 옮겼습니다.
            현재 상태를 먼저 보고, 필요한 작업은 아래 세부 화면으로 이동하는 구조를 사용합니다.
          </p>
        </div>
      </section>
      ...
      <section className="grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm md:p-7">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-semibold text-slate-950">빠른 작업</h3>
              <p className="text-sm text-slate-500">파티관리 안에서 자주 사용하는 작업으로 바로 이동합니다.</p>
            </div>
          </div>
        ...
        <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm md:p-7">
          <h3 className="text-xl font-semibold text-slate-950">현재 파티관리 구조</h3>
          <div className="mt-5 space-y-4 text-sm leading-6 text-slate-600">
            <div className="rounded-2xl bg-slate-50 p-4">
              <p className="font-semibold text-slate-900">최초 진입</p>
              <p className="mt-1">파티 관리 허브에서 현재 상태와 진입점을 먼저 확인합니다.</p>
            </div>
            <div className="rounded-2xl bg-slate-50 p-4">
              <p className="font-semibold text-slate-900">2차 구조</p>
            ...
            <div className="rounded-2xl bg-sky-50 p-4 text-sky-900">
              ...
              <p className="mt-1">
                기존 메인 로직은 파티관리 내부에서 재사용하고, 메인페이지는 소개 중심 랜딩으로 분리합니다.
              </p>
            </div>
          </div>
        </div>
